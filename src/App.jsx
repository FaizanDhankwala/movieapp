  ...
  return (
    <main>
      ...
      <div className="wrapper">
        <header>
          <img src="./hero.png" alt='Hero Banner' className="w-[800px] h-auto mx-auto" />
          <h1>A List of all <span className='text-gradient-yellow-glow'>Movies</span> Ever Released!</h1>
